        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    @foreach($desserts->take(4) as $dessert)
                ...
                <div class="col-md-6">
                    ...
                    @foreach($drinks->take(4) as $dessert)
                        <div class="pricing-entry d-flex ftco-animate">
                            <div class="img"
                                 style="background-image: url({{asset('assets/images/'.$dessert->image)}}); "></div>
                            <div class="desc pl-3">
                                            ...
                                            <div class="col-md-4 text-center">
                                                <div class="menu-wrap">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p><a href="{{route('product.single', $drink->id)}}" class="btn btn-primary btn-outline-primary">Add
                                                                to
                                                                cart</a></p>
                                                    </div>
                                                </div>
