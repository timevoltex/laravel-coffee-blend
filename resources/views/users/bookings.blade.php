            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        ...
                        <p class="breadcrumbs"><span class="mr-2"><a href="{{route('home')}}">Home</a></span> <span>My Booking</span>
                        </p>
                    </div>
                            ...
                            @if($bookings->count() > 0)
                                @foreach($bookings as $booking)
                                    <tr class="text-center gap-0.5" style="height:140px">
                                        <td class="price">{{$booking->first_name}}</td>

                                        <td class="price">{{$booking->last_name}}</td>
