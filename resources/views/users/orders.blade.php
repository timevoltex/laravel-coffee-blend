            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        ...
                        <p class="breadcrumbs"><span class="mr-2"><a href="{{route('home')}}">Home</a></span> <span>My Order</span>
                        </p>
                    </div>
                            ...
                            @if($orders->count() > 0)
                                @foreach($orders as $order)
                                    <tr class="text-center gap-0.5" style="height:140px">
                                        <td class="price">{{$order->first_name}}</td>

                                        <td class="price">{{$order->last_name}}</td>
